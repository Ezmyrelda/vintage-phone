...
SPHINX_PATH := $(HOME)/Projects/VintagePhone/sphinx
...
include $(CLEAR_VARS)
LOCAL_C_INCLUDES := $(SPHINX_PATH)/sphinxbase/include/android $(SPHINX_PATH)/sphinxbase/include $(SPHINX_PATH)/include
